...
var guestList = ["Waqar", "Sana", "Ali", "Zahara", "Anum", "Sumaira"];
...
while (guestList.length > 2) //  Using while loop method for the removal of the elements
 {
    var variable = guestList.pop(); //  By using pop method, removal is done untill loop execution.
    console.log("Sorry ".concat(variable, ", we can not invite you for dinner."));
}
console.log(guestList); //  Printing updated guest list with only two elements remaining
guestList.forEach(function (variable) {
    console.log("".concat(variable, ", You are still invited for the dinner."));
});
