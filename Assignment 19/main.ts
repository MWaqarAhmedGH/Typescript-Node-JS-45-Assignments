...
let guestList: string [] = ["Syeda", "Zahara", "Sawera"];  //  Fetching this guest list from question # 14

//  Printing a message indicating the number of people for the inviting of dinner
