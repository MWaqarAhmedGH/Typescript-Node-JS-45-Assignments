...
var usernames = ["Admin", "User1_Waqar", "User2_Ahmed", "User3_Sawera", "User4_Sana"];
//  By using for loop
...
usernames.forEach(function (variable) {
    if (variable === "Admin") {
        console.log("Hello ".concat(variable, ", would you like to see a status report?"));
    }
    else {
        console.log("Hello ".concat(variable, ", thank you for logging in again."));
    }
});
